<div class="contentManager contentManager--product">
            <div class="contentManager--product__header">
                <div class="contentManager--product__header--title">
                    <h2 style="color: #ffffff;">Số lượng bình luận: 5</h2>
            ...
            <div class="show--productComment">
                <h2>Sản phẩm bình luận: </h2><span> Iphone 14</span>
                <div class="show--productComment--Image">
                    <img width="200px" src="../src/image/iphone14.jpg" alt="">
                </div>
            </div>
            <div class="btn-backtoComment">
                    ...
                    <table border="1">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>1</td>
                                <td class="name">Hoàng Mạnh Tuấn</td>
                                <td class="email">
                                    tuanhmph28448@fpt.edu.vn
                                </td>
                                <td class="content">
                                    Đẹp vãi ò
                                </td>
